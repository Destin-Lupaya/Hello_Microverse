# Hello Microverse
Welcome to my Hello Microverse Project
...
**my-portfolio!** is my First project at Microverse, in this project I follow microverse activity by following github flow, adding required files.
...
- Step 2: Once you have installed git you can clone this project using the command below:
  ```
  git clone https://github.com/Destin-Lupaya/Hello_Microverse
  ```
